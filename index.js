function handleFormSubmit(event){
    ...
    axios.post("https://crudcrud.com/api/da9a7cf2f08a48a891da4dc5fee9d0ea/chocolateshop", 
    chocolatedetails
    )
    ...
    window.addEventListener("DOMContentLoaded", ()=>{
        axios.get("https://crudcrud.com/api/da9a7cf2f08a48a891da4dc5fee9d0ea/chocolateshop")
        .then((resolve)=> {
            console.log(resolve);
    ...
    function displayshopdetails(chocolatedetails){
        ...
        buybtn.addEventListener("click", function (event){
            ...
            localStorage.removeItem(chocolatedetails.quantity);
